...
export default function ColumnForm({ table, column, onClose }) {
 ...
 className="mt-1 block w-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-white/5 dark:border-white/10 dark:text-white"
 ...
 disabled={isEditing}
 className="mt-1 block w-full border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm dark:bg-white/5 dark:border-white/10 dark:text-white disabled:opacity-50"
 >
 ...
 {isLookupType && (
 <div className="border border-indigo-200 dark:border-indigo-800 p-4 bg-indigo-50 dark:bg-indigo-900/10">
 ...
 type="button"
 onClick={onClose}
 className="bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 dark:bg-white/5 dark:text-white dark:ring-white/10 dark:hover:bg-white/10"
 >
 Cancel
 </button>
 <button
