      ...
      <div className="px-4 py-2 flex items-center border-r border-gray-100 dark:border-white/5">
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {task.is_milestone && (
              <span className="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-semibold bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 ring-1 ring-inset ring-purple-700/10 dark:ring-purple-400/20">
                Milestone
              </span>
            )}
            {task.is_critical_path && (
              <span className="inline-flex items-center px-2 py-0.5 rounded-md text-xs font-semibold bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-300 ring-1 ring-inset ring-red-700/10 dark:ring-red-400/20">
                Critical
              </span>
            )}
          </div>
