...
export default function ColorCustomizationMenu({ tasks, colorConfig, onColorChange, colorBy }) {
 ...
 <MenuButton className="inline-flex items-center gap-2 bg-white px-4 py-2 text-sm font-medium text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">
 ...
 >
 <MenuItems className="absolute right-0 z-10 mt-2 w-80 origin-top-right bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
 <div className="p-4">
 {/* Tab Navigation */}
 ...
 <MenuButton
 className={`inline-flex items-center gap-2 px-3 py-1.5 text-xs font-medium ring-1 ring-inset ${currentColor.badge}`}
 >
 {currentColor.name}
 ...
 leaveTo="transform opacity-0 scale-95"
 >
 <MenuItems className="absolute right-0 z-20 mt-1 w-40 origin-top-right bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
 ...
 className={` px-2 py-1.5 text-xs font-medium ring-1 ring-inset transition-colors ${color.badge} ${
 active ? 'opacity-75' : ''
