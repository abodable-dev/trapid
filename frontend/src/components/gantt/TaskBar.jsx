...
export default function TaskBar({ task, left, width, pixelsPerDay, colorBy = 'status', colorConfig }) {
  ...
  return (
    <div
      className="absolute top-2 rounded-lg group cursor-pointer transition-all hover:ring-2 hover:ring-offset-1 hover:ring-indigo-500 dark:hover:ring-indigo-400 hover:shadow-md"
      style={{
        left: `${left}px`,
        width: `${width}px`,
        height: '32px',
    ...
    >
      ...
      <div className="absolute left-0 top-full mt-1 hidden group-hover:block z-30 pointer-events-none">
        <div className="bg-gray-900 dark:bg-gray-700 text-white text-xs rounded-lg shadow-lg py-2 px-3 whitespace-nowrap">
