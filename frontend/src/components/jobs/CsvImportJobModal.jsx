...
export default function CsvImportJobModal({ isOpen, onClose, onSuccess }) {
 ...
 >
 <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden bg-white dark:bg-gray-900 p-6 text-left align-middle shadow-xl transition-all">
 {/* Header */}
 ...
 {/* Success Message */}
 {importResult && (
 <div className="mb-6 bg-green-100 dark:bg-green-400/10 p-4">
 <div className="flex">
 ...
 {/* Error Message */}
 {error && (
 <div className="mb-6 bg-red-100 dark:bg-red-400/10 p-4">
 <div className="flex">
 ...
 <div className="mt-1 flex justify-center border-2 border-dashed border-gray-300 dark:border-gray-700 px-6 py-10">
 <div className="text-center">
 <DocumentArrowUpIcon className="mx-auto h-12 w-12 text-gray-400" />
 <div className="mt-4 flex text-sm text-gray-600 dark:text-gray-400">
 <label
 htmlFor="file-upload"
 className="relative cursor-pointer font-semibold text-indigo-600 dark:text-indigo-500 hover:text-indigo-500"
 >
 ...
 className="block w-full border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm"
 required
 />
 </div>
 ...
 className="bg-white dark:bg-gray-800 px-3 py-2 text-sm font-semibold text-gray-900 dark:text-white shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50"
 >
 Cancel
 </button>
 <button
 ...
 className="bg-indigo-600 dark:bg-indigo-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 dark:hover:bg-indigo-400 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:opacity-50"
 >
 {isSubmitting ? (
