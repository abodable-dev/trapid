...
export default function DeleteJobModal({ isOpen, onClose, onConfirm, job, isDeleting }) {
 ...
 onClick={handleClose}
 disabled={isDeleting}
 className="bg-white text-gray-400 hover:text-gray-500 focus:outline focus:outline-2 focus:outline-offset-2 focus:outline-indigo-600 disabled:opacity-50 dark:bg-gray-800 dark:hover:text-gray-300 dark:focus:outline-white"
 >
 ...
 <div className="mt-4 bg-yellow-50 dark:bg-yellow-900/20 p-4 border border-yellow-200 dark:border-yellow-800">
 <p className="text-sm font-medium text-yellow-800 dark:text-yellow-200 mb-2">
 This will permanently delete:
 </p>
 <ul className="list-disc list-inside text-sm text-yellow-700 dark:text-yellow-300 space-y-1">
 <li>All purchase orders</li>
 <li>All schedule tasks</li>
 <li>All documents</li>
 <li>All job data</li>
 </ul>
 <p className="text-sm text-yellow-700 dark:text-yellow-300 mt-2">
 Estimates will be kept but unlinked from this job.
 </p>
 </div>
 ...
 disabled={isDeleting}
 placeholder="DELETE"
 className="mt-2 block w-full border-0 py-2 px-3 text-gray-900 dark:text-white bg-white dark:bg-gray-900 ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-red-600 disabled:opacity-50 sm:text-sm"
 />
 </div>
 ...
 className="inline-flex w-full justify-center bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 sm:ml-3 sm:w-auto disabled:opacity-50 disabled:cursor-not-allowed dark:bg-red-500 dark:shadow-none dark:hover:bg-red-400"
 >
