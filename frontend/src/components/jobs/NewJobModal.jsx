...
export default function NewJobModal({ isOpen, onClose, onSuccess }) {
 ...
 >
 <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden bg-white dark:bg-gray-800 shadow-2xl transition-all">
 {/* Header */}
 ...
 <div className="bg-indigo-100 dark:bg-indigo-900/30 p-2">
 ...
 className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white transition-all"
 autoFocus
 required
 />
 </div>
 ...
 <div className="group">
 <label className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
 <div className="bg-blue-100 dark:bg-blue-900/30 p-2">
 ...
 <Combobox.Input
 className="w-full px-4 py-3 pr-10 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white transition-all"
 ...
 >
 <Combobox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto bg-white dark:bg-gray-800 py-1 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
 {loadingClients && (
 ...
 <div className="group">
 <label className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
 <div className="bg-amber-100 dark:bg-amber-900/30 p-2">
 ...
 <div className="group">
 <label className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
 <div className="bg-emerald-100 dark:bg-emerald-900/30 p-2">
 ...
 placeholder="0.00"
 className="w-full pl-8 pr-4 py-3 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white transition-all"
 />
 </div>
 </div>
 ...
 <div className="group">
 <label className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
 <div className="bg-purple-100 dark:bg-purple-900/30 p-2">
 ...
 <label className="flex items-center gap-3 p-3 border border-gray-300 dark:border-gray-600 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
 <input
 type="checkbox"
 ...
 <label className="flex items-start gap-3 p-4 border border-gray-300 dark:border-gray-600 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors bg-blue-50/50 dark:bg-blue-900/10">
 <input
 type="checkbox"
 ...
 <div className="group">
 <label className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">
 <div className="bg-teal-100 dark:bg-teal-900/30 p-2">
 ...
 <div className="group">
 <label className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
 <div className="bg-cyan-100 dark:bg-cyan-900/30 p-2">
 ...
 <div className="group">
 <label className="flex items-center gap-2 text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
 <div className="bg-rose-100 dark:bg-rose-900/30 p-2">
 ...
 {/* Summary Card */}
 <div className="mt-6 bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 border border-indigo-200 dark:border-indigo-800 p-6">
 ...
 className="inline-flex items-center gap-2 px-6 py-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-indigo-500/30"
 >
 Next
 ...
 className="inline-flex items-center gap-2 px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 transition-all disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-indigo-500/30"
 >
 {isSubmitting ? (
 <>
