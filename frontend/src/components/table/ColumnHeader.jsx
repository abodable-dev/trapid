...
export default function ColumnHeader({ column, onTypeChange, tableId }) {
 ...
 className="flex items-center gap-x-2 hover:bg-gray-100 dark:hover:bg-gray-700 px-2 py-1 -mx-2 -my-1 transition-colors w-full"
 >
 ...
 {isOpen && (
 <div className="absolute top-full left-0 mt-1 w-56 bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 z-50 py-1">
