...
export default function AddColumnModal({ isOpen, onClose, onAdd, tableId }) {
 ...
 <div className="relative bg-white dark:bg-gray-800 shadow-xl w-full max-w-md overflow-hidden">
 {/* Header */}
 ...
 <div className="border border-gray-300 dark:border-gray-600 max-h-96 overflow-y-auto">
 {/* Category Header */}
 ...
 rows={3}
 className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:text-white font-mono text-sm"
 required
 />

 {/* Column suggestions dropdown */}
 {showColumnSuggestions && filteredColumns.length > 0 && (
 <div className="absolute z-10 mt-1 w-full bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-600 shadow-lg max-h-60 overflow-y-auto">
 ...
 className="px-4 py-2 text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
 >
