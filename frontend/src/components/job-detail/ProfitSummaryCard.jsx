            ...
            {savingsCategories.map((category) => (
              <div key={category.name} className="text-sm">
                <button
                  ...
                  className="w-full flex items-center justify-between p-2 hover:bg-green-50 dark:hover:bg-green-900/10 rounded transition-colors"
                >
          ...
          <div className="space-y-2">
            {overrunCategories.map((category) => (
              <div key={category.name} className="text-sm">
                <button
                  onClick={() => toggleCategory(category.name)}
                  className="w-full flex items-center justify-between p-2 hover:bg-red-50 dark:hover:bg-red-900/10 rounded transition-colors"
                >
                  <div className="flex items-center gap-2">
                    {expandedCategories.has(category.name) ? (
                      <ChevronDownIcon className="h-4 w-4 text-gray-400" />
