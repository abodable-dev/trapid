      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        {tasks.map((task) => {
          ...
          return (
            <div
              key={task.id}
              className="relative flex items-start space-x-3 rounded-lg border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 px-4 py-4 shadow-sm hover:border-gray-300 dark:hover:border-gray-600 transition-colors"
            >
