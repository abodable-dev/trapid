...
export default function GrokChat({ isOpen, onClose }) {
 ...
 className="text-xs bg-indigo-600 hover:bg-indigo-500 text-white px-3 py-1.5 font-medium"
 >
 ...
 rows={2}
 disabled={loading}
 className="flex-1 resize-none border-gray-300 dark:border-white/10 bg-white dark:bg-gray-800 text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-gray-500 focus:border-indigo-500 focus:ring-indigo-500 text-sm disabled:opacity-50"
 />
 <button
 onClick={handleSend}
 disabled={!input.trim() || loading}
 className="bg-indigo-600 p-2 text-white hover:bg-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed"
 >
