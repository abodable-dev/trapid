...
const TableFooter = React.forwardRef(({ className, ...props }, ref) => (
 <tfoot
 ref={ref}
 className={cn("border-t border-gray-800 bg-gray-900 font-medium [&>tr]:last:border-b-0", className)}
 {...props}
 />
))
...
const TableRow = React.forwardRef(({ className, ...props }, ref) => (
 ...
 ref={ref}
 className={cn(
"border-b border-gray-800 transition-colors duration-200 hover:bg-gray-900/50 data-[state=selected]:bg-gray-900",
 className
 )}
 {...props}
 />
