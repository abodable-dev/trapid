...
export default function ExplorerSidebar({ onUploadClick }) {
 ...
 className="w-full flex items-center justify-center gap-2 px-4 py-2.5 bg-indigo-600 hover:bg-indigo-700 text-white transition-colors font-medium text-sm"
 >
