...
export default function PriceBookImportModal({ isOpen, onClose, onImportSuccess }) {
 ...
 >
 <Dialog.Panel className="w-full max-w-2xl transform overflow-hidden bg-white dark:bg-gray-800 text-left align-middle shadow-xl transition-all">
 {/* Header */}
 ...
 className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 border border-gray-300 dark:border-gray-600 hover:bg-gray-50 dark:hover:bg-gray-600"
 >
 Import Another File
 </button>
 <button
 ...
 {/* Help Text */}
 {!result && !uploading && (
 <div className="mt-6 bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-200 dark:border-indigo-800 p-4">
