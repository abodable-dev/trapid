    ...
    <Menu as="div" className="relative inline-block text-left w-full">
      {({ open }) => (
        <>
          ...
          >
            <Menu.Items className="absolute left-0 z-50 mt-2 w-64 origin-top-left rounded-md bg-white dark:bg-gray-800 shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
              <div className="p-2">
                {/* Sort options */}
                      ...
                      <div className="sticky top-0 bg-white dark:bg-gray-800 px-2 py-2">
                        <div className="relative">
                          ...
                          <input
                            ...
                            placeholder="Search..."
                            className="w-full pl-8 pr-2 py-1.5 text-sm border border-gray-300 dark:border-gray-600 rounded-md focus:ring-2 focus:ring-indigo-500 dark:bg-gray-700 dark:text-white"
                          />
                        </div>
                      </div>
                        ...
                        <Menu.Item key={option.value}>
                          {({ active }) => (
                            <button
                              ...
                              } group flex w-full items-center justify-between rounded-md px-2 py-2 text-sm text-gray-900 dark:text-white`}
                            >
                  ...
                  {filterType === 'search' && (
                    <form onSubmit={handleSearchSubmit} onClick={(e) => e.stopPropagation()}>
                      <div className="px-2 py-2">
                        ...
                        <button
                          type="submit"
                          className="w-full mt-2 px-3 py-1.5 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-md"
                        >
                          Apply Filter
                        </button>
                      </div>
                  ...
                  {filterType === 'price-range' && (
                    <form onSubmit={handlePriceRangeSubmit} onClick={(e) => e.stopPropagation()}>
                      <div className="px-2 py-2 space-y-2">
                        ...
                        <button
                          type="submit"
                          className="w-full px-3 py-1.5 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 rounded-md"
                        >
                          Apply Filter
                        </button>
                      </div>
