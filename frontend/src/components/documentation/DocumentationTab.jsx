...
export default function DocumentationTab() {
 ...
 className="block w-full pl-10 pr-3 py-3 border border-gray-300 dark:border-gray-600 leading-5 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
 />
 </div>
 ...
 <div
 key={section.id}
 className={`bg-white dark:bg-gray-800 border ${colorClasses.border} ${colorClasses.hover} overflow-hidden transition-all`}
 >
 {/* Section Header */}
 <button
 ...
 <div className={`flex-shrink-0 w-12 h-12 ${colorClasses.bg} flex items-center justify-center`}>
 ...
 {/* Help Footer */}
 <div className="bg-gradient-to-br from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 p-6 border border-indigo-200 dark:border-indigo-800">
 <div className="flex items-start gap-4">
 <div className={`flex-shrink-0 w-12 h-12 ${getColorClasses('indigo').bg} flex items-center justify-center`}>
