...
const CHAPTER_NAMES = {
  0: 'Getting Started',
  1: 'Logging In & User Profiles',
  2: 'Company Settings',
  3: 'Managing Contacts',
  4: 'Setting Up Price Books',
  5: 'Creating a New Job',
  6: 'Importing & Managing Estimates',
  7: 'AI-Powered Plan Review',
  8: 'Generating Purchase Orders',
  9: 'Building Construction Schedules',
  10: 'Daily Tasks & Checklists',
  11: 'Weather Tracking & Delays',
  12: 'OneDrive File Management',
  13: 'Email Integration',
  14: 'Team Chat & SMS',
  15: 'Xero Accounting Sync',
  16: 'Payment Tracking',
  17: 'Workflow Automation',
  18: 'Custom Data Tables',
  19: 'UI/UX Standards & Patterns',
  20: 'Agent System & Automation'
}

// Parse markdown content to extract sections (## headings under chapters)
const parseSectionsFromMarkdown = (content) => {
  ...
  lines.forEach((line, index) => {
    ...
    // Match section headers: ## any heading
    ...
    // Match next chapter or heading (stop collecting)
    if (line.match(/^#\s+/)) {
...
const COLUMNS = [
  ...
  { key: 'title', label: 'Title', resizable: true, sortable: true, filterable: true, filterType: 'text', width: 450 }
]
...
export default function UserManualTableView({ content }) {
  ...
  useEffect(() => {
    const savedState = localStorage.getItem('manualTableViewState')
    if (savedState) {
      try {
  ...
  useEffect(() => {
    ...
    localStorage.setItem('manualTableViewState', JSON.stringify(state))
  ...
  const filteredAndSorted = useMemo(() => {
    ...
    result.sort((a, b) => {
      ...
      switch (sortBy) {
        case 'section':
          // Sort by section number (e.g., 0.1, 0.2, 1.1)
  ...
  return (
    <>
      <style>{`
        ...
        .dark .manual-table-scroll {
          scrollbar-color: #9CA3AF #4B5563 !important;
        }
        .manual-table-scroll::-webkit-scrollbar {
          width: 14px !important;
          height: 14px !important;
        }
        .manual-table-scroll::-webkit-scrollbar-track {
          background: #E5E7EB !important;
        }
        .manual-table-scroll::-webkit-scrollbar-thumb {
          background: #9CA3AF !important;
          border-radius: 6px !important;
          border: 2px solid #E5E7EB !important;
        }
        .manual-table-scroll::-webkit-scrollbar-thumb:hover {
          background: #6B7280 !important;
        }
        .dark .manual-table-scroll::-webkit-scrollbar-track {
          background: #4B5563 !important;
        }
        .dark .manual-table-scroll::-webkit-scrollbar-thumb {
          background: #9CA3AF !important;
          border-color: #4B5563 !important;
        }
        .dark .manual-table-scroll::-webkit-scrollbar-thumb:hover {
      ...
      <div className="h-full flex flex-col overflow-hidden bg-white dark:bg-gray-900">
        ...
        {/* Table */}
        <div className="manual-table-scroll flex-1 overflow-y-auto overflow-x-auto relative bg-white dark:bg-gray-900 min-h-0">
