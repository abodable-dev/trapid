                  ...
                  <div className="flex items-center space-x-2 ml-4">
                    ...
                    {['pending', 'matched'].includes(estimate.status) && (
                      <button
                        ...
                        className="inline-flex items-center px-3 py-1.5 border border-gray-300 dark:border-gray-600 rounded-md text-sm font-medium text-red-700 dark:text-red-400 bg-white dark:bg-gray-800 hover:bg-red-50 dark:hover:bg-red-900/10 transition-colors"
                      >
