...
export default function OneDriveConnection() {
 ...
 {/* Connection Status */}
 <div className="border border-gray-200 bg-white p-6 dark:border-white/10 dark:bg-white/5">
 ...
 <div className="bg-blue-50 p-4 dark:bg-blue-900/10">
 ...
 className="bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-red-600 dark:bg-red-500 dark:hover:bg-red-400"
 >
 Disconnect
 </button>
 </div>
 ...
 <div className="mt-4 bg-gray-50 p-4 dark:bg-gray-800/50">
 ...
 disabled={connecting}
 className="bg-indigo-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:opacity-50 dark:bg-indigo-500 dark:hover:bg-indigo-400"
 >
 {connecting ? (
 ...
 className="inline-flex w-full justify-center bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500 disabled:opacity-50 sm:ml-3 sm:w-auto dark:bg-red-500 dark:hover:bg-red-400"
 >
 ...
 disabled={disconnecting}
 className="mt-3 inline-flex w-full justify-center bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 disabled:opacity-50 sm:mt-0 sm:w-auto dark:bg-white/5 dark:text-white dark:ring-white/10 dark:hover:bg-white/10"
 >
 Cancel
 </button>
 </div>
