...
export default function ScheduleTaskList({ tasks, loading, onMatchTask, onUnmatch }) {
 ...
 className="inline-flex items-center px-2.5 py-1.5 border border-gray-300 dark:border-gray-600 text-xs font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors"
 >
 ...
 className="inline-flex items-center px-2.5 py-1.5 border border-red-300 dark:border-red-800 text-xs font-medium text-red-700 dark:text-red-400 bg-white dark:bg-gray-800 hover:bg-red-50 dark:hover:bg-red-900/30 transition-colors"
 >
