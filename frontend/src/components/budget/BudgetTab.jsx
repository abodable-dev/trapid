...
export default function BudgetTab({ jobId }) {
 ...
 if (error) {
 return (
 <div className="bg-white dark:bg-gray-800 shadow sm: border border-red-200 dark:border-red-700">
 <div className="px-4 py-5 sm:p-6">
 <p className="text-sm text-red-600 dark:text-red-400">{error}</p>
 <button
 onClick={loadBudgetData}
 className="mt-3 inline-flex items-center px-3 py-2 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
 >
 ...
 <div className="bg-white dark:bg-gray-800 shadow border border-gray-200 dark:border-gray-700 p-4">
 ...
 <button
 onClick={loadBudgetData}
 className="inline-flex items-center px-3 py-1.5 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600"
 >
 <ArrowPathIcon className="h-4 w-4 mr-2" />
 Refresh
 </button>
