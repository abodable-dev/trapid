...
export default function ColumnVisibilityModal({ isOpen, onClose, columns, visibleColumns, onToggleColumn }) {
 ...
 >
 <Dialog.Panel className="w-full max-w-md transform overflow-hidden bg-white dark:bg-gray-800 p-6 shadow-xl transition-all">
 ...
 <button
 onClick={onClose}
 className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 transition"
 >
 Close
 </button>
 </div>
