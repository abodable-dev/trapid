...
export default function TablePage() {
 ...
 <button
 type="button"
 className="inline-flex items-center gap-x-1.5 px-3 py-1.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
 >
 ...
 className="inline-flex items-center gap-x-1.5 px-3 py-1.5 text-sm bg-blue-600 text-white hover:bg-blue-700 ml-2 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 onClick={handleAddRow}
 disabled={isAddingRow}
 className="inline-flex items-center gap-x-1.5 px-3 py-1.5 text-sm bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 <PlusIcon className="h-4 w-4" />
 ...
 className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-700 p-0.5 transition-colors"
 title="Add column"
 >
