...
export default function SettingsPage() {
 ...
 <TabList className="flex space-x-1 bg-gray-100 dark:bg-gray-800 p-1 max-w-2xl">
 <Tab
 className={({ selected }) =>
 `w-full py-2.5 px-4 text-sm font-medium leading-5 transition-all
 ${
 selected
 ...
 <div className="bg-white dark:bg-gray-800 shadow-sm ring-1 ring-gray-900/5 dark:ring-white/10">
 ...
 className="inline-flex items-center gap-2 bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
 >
