...
export default function JobDetailPage() {
 ...
 <div className="flex h-12 w-12 items-center justify-center bg-indigo-600">
 ...
 className="flex items-center justify-center h-10 w-10 border-2 border-indigo-200 dark:border-indigo-800 bg-white dark:bg-gray-800 hover:bg-indigo-50 dark:hover:bg-indigo-900/20 transition-colors group"
 ...
 <div
 key={stat.name}
 className="overflow-hidden bg-white dark:bg-gray-800 px-4 py-5 shadow sm:p-6 border border-gray-200 dark:border-gray-700"
 >
 ...
 disabled={saving}
 className="inline-flex items-center px-3 py-1.5 border border-gray-300 dark:border-gray-600 text-sm font-medium text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors disabled:opacity-50"
 >
 ...
 onClick={handleSave}
 disabled={saving}
 className="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition-colors disabled:opacity-50"
 >
 ...
 className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 text-sm bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500"
 />
 </div>
 <div>
 <label className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
 ...
 <div className="w-full px-3 py-2 border border-gray-200 dark:border-gray-700 text-sm bg-gray-50 dark:bg-gray-800 text-gray-900 dark:text-white">
 ...
 className="inline-flex items-center px-3 py-1.5 border border-transparent text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700"
 >
