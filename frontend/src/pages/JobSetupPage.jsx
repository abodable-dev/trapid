...
export default function JobSetupPage() {
 ...
 <div className="bg-green-100 dark:bg-green-900/30 p-3">
 ...
 <div className="flex items-start gap-4">
 <div className="flex-shrink-0">
 <div className="bg-blue-100 dark:bg-blue-900/30 p-3">
 ...
 className="inline-flex items-center px-3 py-1 text-xs font-medium bg-red-100 text-red-800 hover:bg-red-200 dark:bg-red-900/40 dark:text-red-200"
 >
 Retry
 </button>
 )}
 ...
 className="inline-flex items-center px-4 py-2 text-sm font-medium bg-indigo-600 text-white hover:bg-indigo-700"
 >
 Start
 </button>
 )}
 ...
 className="inline-flex items-center px-4 py-2 text-sm font-medium bg-indigo-600 text-white hover:bg-indigo-700 disabled:opacity-50"
 >
 ...
 <div className="bg-white dark:bg-gray-800 shadow-sm border border-gray-200 dark:border-gray-700 p-6 opacity-90">
 <div className="flex items-start gap-4">
 <div className="flex-shrink-0">
 <div
 className={` p-3 ${
 ...
 <span className="inline-flex items-center px-2 py-0.5 text-xs font-medium bg-gray-100 text-gray-600 dark:bg-gray-700 dark:text-gray-400">
 Optional
 </span>
 </div>
 <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
 ...
 <button
 onClick={() => navigate(`/jobs/${id}`)}
 className="inline-flex items-center px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 transition-all shadow-lg shadow-indigo-500/30"
 >
 Done
 </button>
 </div>
 ...
 >
 <Dialog.Panel className="w-full max-w-md transform overflow-hidden bg-white dark:bg-gray-800 shadow-2xl transition-all">
 ...
 className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
 required
 />
 </div>
 ...
 placeholder="0.00"
 className="w-full pl-8 pr-4 py-2 border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 dark:bg-gray-700 dark:text-white"
 required
 />
 </div>
 </div>
 ...
 <button
 type="submit"
 className="px-6 py-2 text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700 transition-colors"
 >
 Save
 </button>
 </div>
