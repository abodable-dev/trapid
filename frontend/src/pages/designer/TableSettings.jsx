...
export default function TableSettings() {
 ...
 className="bg-red-600 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-red-500"
 >
 Delete Table
 </button>
 </div>
 ...
 disabled
 className="mt-1 block w-full border-gray-300 bg-gray-50 shadow-sm sm:text-sm dark:bg-white/5 dark:border-white/10 dark:text-gray-400"
 />
 <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
