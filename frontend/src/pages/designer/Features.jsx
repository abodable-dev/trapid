...
export default function Features({ onOpenGrokChat }) {
 ...
 {/* Grok Chat CTA */}
 <div className="mb-8 bg-gradient-to-r from-indigo-50 to-purple-50 dark:from-indigo-900/20 dark:to-purple-900/20 p-6 border border-indigo-200 dark:border-indigo-800">
 ...
 className="inline-flex items-center gap-x-2 bg-black hover:bg-gray-800 px-4 py-2 text-sm font-semibold text-white shadow-sm"
 >
 ...
 {plans.length === 0 ? (
 <div className="text-center py-12 bg-gray-50 dark:bg-gray-800/50 border border-gray-200 dark:border-white/10">
 ...
 <div
 key={plan.id}
 className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-white/10 p-4 hover:border-indigo-300 dark:hover:border-indigo-700 transition-colors"
 >
