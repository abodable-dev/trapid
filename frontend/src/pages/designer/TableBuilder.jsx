...
export default function TableBuilder() {
 ...
 className="text-lg font-normal text-gray-900 dark:text-white cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 px-2 py-1"
 >
 {tableName}
 </h1>
 )}
 ...
 className="px-3 py-1.5 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800"
 >
 Cancel
 </button>
 <button
 ...
 <MenuButton className="flex items-center gap-x-1 hover:bg-gray-200 dark:hover:bg-gray-700 px-1.5 py-1">
 {getTypeIcon(column.column_type)}
 <ChevronDownIcon className="h-3 w-3 text-gray-500 dark:text-gray-400" />
 </MenuButton>
 <MenuItems className="absolute left-0 z-30 mt-2 w-64 origin-top-left bg-white dark:bg-gray-800 py-1 shadow-lg ring-1 ring-black/5 dark:ring-white/10 focus:outline-none max-h-96 overflow-y-auto">
 ...
 className="opacity-0 group-hover:opacity-100 transition-opacity p-1 hover:bg-gray-200 dark:hover:bg-gray-700"
 >
