...
export default function ContactDetailPage() {
 ...
 className="inline-flex items-center gap-2 px-4 py-2 bg-blue-600 text-white hover:bg-blue-700 transition"
 >
 <ArrowLeftIcon className="h-5 w-5" />
 Back to Contacts
 </button>
 ...
 className="inline-flex items-center gap-2 px-4 py-2 bg-red-600 text-white hover:bg-red-700 transition"
 >
 ...
 <div key={supplier.id} className="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-750">
