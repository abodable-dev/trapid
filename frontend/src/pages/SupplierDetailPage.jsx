...
export default function SupplierDetailPage() {
 ...
 className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 dark:bg-gray-800 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-700 transition-colors"
 >
 ...
 className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-red-600 bg-white border border-red-300 hover:bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800 dark:hover:bg-red-900/20 transition-colors"
 >
 ...
 <div className="bg-white dark:bg-gray-800 px-5 py-4 border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-md transition-shadow">
 ...
 className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-colors"
 >
 ...
 className="w-full px-2 py-1 text-sm border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
 />
 ) : (
 ...
 className="w-32 px-2 py-1 text-sm text-right border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:text-white"
 />
 ) : (
 ...
 className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium text-white bg-green-600 hover:bg-green-700 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 ...
 onClick={cancelEdit}
 disabled={savingItemId === item.id}
 className="inline-flex items-center gap-1 px-3 py-1 text-xs font-medium text-gray-700 bg-white border border-gray-300 hover:bg-gray-50 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-600 dark:hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed"
 >
 Cancel
 </button>
 </div>
 ...
 <div className="bg-white dark:bg-gray-800 shadow-xl max-w-2xl w-full mx-4">
 ...
 className="block w-full text-sm text-gray-900 dark:text-white border border-gray-300 dark:border-gray-600 cursor-pointer bg-gray-50 dark:bg-gray-700 focus:outline-none"
 />
 {importFile && (
