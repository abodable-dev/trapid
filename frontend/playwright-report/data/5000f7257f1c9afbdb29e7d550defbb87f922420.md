...
- generic [ref=e2]:
  ...
  - generic [ref=e10]:
    ...
    - link "Why did this happen?" [ref=e11] [cursor=pointer]:
      - /url: "#"
    - generic [ref=e12]:
      - text: "IP address: 65.181.3.15"
      - text: "Time: 2025-11-18T02:41:26Z"
      - text: "URL: https://www.google.com/search?q=there+is+no+scroll+on+right+hand+side&oq=there+is+no+scroll+on+right+hand+side&gs_lcrp=EgZjaHJvbWUyBggAEEUYOdIBCDY2OTlqMGo0qAIAsAIA&sourceid=chrome&ie=UTF-8&sei=1dwbacvxOILF1e8P56vpwQE"
```